...
export default function EditEmployeePage() {
  ...
  if (!employeeId) {
    return (
      <EmptyState
        message="Pick an employee from the directory to edit their profile."
  ...
  if (employeeFormQuery.isError || !employeeFormQuery.data?.form) {
    return (
      <EmptyState
        message="We couldn’t load the employee form. Try opening it from the directory again."
        directoryHref={tenantPath("/hr-admin/employees")}
      />
    );
  }
    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            href={tenantPath(`/hr-admin/employees/view/${encodeURIComponent(employeeId)}`)}
