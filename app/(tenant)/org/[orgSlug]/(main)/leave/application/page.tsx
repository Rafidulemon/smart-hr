...
import RadioGroup from "@/app/components/atoms/inputs/RadioGroup";
    ...
    <div>
      <div className="space-y-6">
        <EmployeeHeader
          ...
          onButtonClick={() => router.push(tenantPath("/leave"))}
        />
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 md:grid-cols-2">
                ...
                <div className="col-span-2 flex flex-wrap justify-end gap-3 pt-2">
                  ...
                  <Button
                    ...
                    type="button"
                    className="w-full sm:w-auto"
                    onClick={() => router.push(tenantPath("/leave"))}
                  >
